...
import { exportPayslips } from '../../utils/payslipExcel';
...
const PayslipView = ({ onBack }) => {
  ...
  const exportPayslipsToExcel = () =>
    exportPayslips({ filteredPayslips, employees, sites, selectedMonth, selectedSite });
            ...
            <>
              ...
              <div className="border-t pt-4">
                ...
                <p className="text-sm text-slate-500 mb-4">
                  Salary advances are now recovered automatically from the <span className="font-medium">Advances</span> section — no need to enter them here.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
