 ...
 *
 * IMPORTANT: keep this byte-for-byte in sync with the backend copy at
 * backend/src/utils/numberToWords.js. The client-generated payslip PDF (admin
 * @react-pdf) and the server-generated one (employee portal) both render this,
 * so if the two drift they will state different words for the same net pay.
 */
